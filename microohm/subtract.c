...
static NPY_CASTING
qq_subtract_resolve_descriptors(
    PyObject *self,
    ...
    npy_intp *unused)
{
    ...
    {
        PyErr_SetString(PyExc_ValueError, "can only subtract units of the same dimension");
        return -1;
    }
...
int init_subtract_ufunc(void)
{
    ...
    static PyType_Slot slots[] = {
        {NPY_METH_resolve_descriptors, &qq_subtract_resolve_descriptors},
        {NPY_METH_strided_loop, &dd_subtract_strided_loop},
        {0, NULL}};
    PyArrayMethod_Spec qq_SubtractSpec = {
        .name = "qq_subtract",
        .nin = 2,
        .nout = 1,
        .dtypes = dtypes,
    ...
    if (PyUFunc_AddLoopFromSpec(subtract, &qq_SubtractSpec) < 0)
    {
        Py_DECREF(subtract);
        return -1;
    }
